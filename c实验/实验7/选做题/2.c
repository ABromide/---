...
void paixu2(struct class_score_form *head)
{
       double a,b;
       int i=0,k=0;
     struct class_score_form *pp,*stu_1,*stu_2,*back,*q,*p;
      struct class_score_form *prior1,*prior2;
     pp=head;

     for(prior1=pp,stu_1=prior1->next;stu_1->next!=NULL; prior1=stu_1,stu_1=stu_1->next)

    {
        for(stu_2=stu_1->next,prior2=stu_1; stu_2!=NULL;prior2=stu_2,stu_2=stu_2->next)
      {
